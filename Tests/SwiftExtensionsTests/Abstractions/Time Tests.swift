...
@Suite
struct Abstractions_Time_Tests {
    @Test
    func time() {
        // current system time
        //
    ...
    func timeLocalizedStringValue_VariousLocales() {
        // German / Germany
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .s, locale: .init(identifier: "de_DE"))
                == "3723"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .s_sss, locale: .init(identifier: "de_DE"))
                == "3723,000"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .h_mm_ss, locale: .init(identifier: "de_DE"))
                == "1:02:03"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .h_mm_ss_sss, locale: .init(identifier: "de_DE"))
                == "1:02:03,000"
        )

        // Finnish / Finland
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .s, locale: .init(identifier: "fi_FI"))
                == "3723"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .s_sss, locale: .init(identifier: "fi_FI"))
                == "3723,000"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .h_mm_ss, locale: .init(identifier: "fi_FI"))
                == "1.02.03"
        )
        #expect(
            Time(hours: 1, minutes: 2, seconds: 3).localizedStringValue(format: .h_mm_ss_sss, locale: .init(identifier: "fi_FI"))
                == "1.02.03,000"
        )
    }
    ...
    func durationIntervalSetA() {
        ...
        t.durationInterval = .milliseconds(50000)
    ...
    func durationIntervalSetD() {
        ...
        t.durationInterval = .milliseconds(-40000)
