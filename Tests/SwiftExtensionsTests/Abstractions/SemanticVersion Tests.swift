...
struct SemanticVersionTests {
    ...
    @Test
    func init_string_valid_allowLeadingV() {
    ...
    @available(macOS 15, *)
    @Test
    func propertySetters_edgeCases() async {
    ...
    @Test
    func comparable_preReleaseAndBuild() {
