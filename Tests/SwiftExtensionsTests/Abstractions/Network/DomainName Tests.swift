...
struct Abstractions_DomainNameTests {
    ...
    @Test
    func initString_OneTLDComponent_OnePrefix() {
    ...
    @Test
    func initString_OneTLDComponent_TwoPrefixes() {
    ...
    @Test
    func initString_TwoTLDComponents_NoPrefix() {
    ...
    @Test
    func initString_TwoTLDComponents_OnePrefix() {
    ...
    @Test
    func initString_TwoTLDComponents_TwoPrefixes() {
