...
@Suite
struct Extensions_Swift_Collections_Tests {
    ...
    @Test
    func subscript_Safe_Set_EdgeCases() async {
        // [Int]
        var arr = [1, 2, 3, 4, 5, 6]
    ...
    @Test
    func subscript_SafePosition_Set_EdgeCases() async {
        // [Int]
        var arr = [1, 2, 3, 4, 5, 6]
    ...
    func removingDuplicatesRandomOrdering() {
        ...
        #expect(
            [1, 2, 3, 4]
                .removingDuplicatesRandomOrdering()
    ...
    @Test
    func contains_anyElementsIn_ClosedRange() {
    ...
    @Test
    func contains_anyElementsIn_ClosedRanges_noRanges() {
    ...
    @Test
    func contains_anyElementsIn_ClosedRanges_oneRange() {
        #expect(!([] as [Int]).contains(anyElementsIn: [0 ... 1]))
        #expect([0].contains(anyElementsIn: [0 ... 0]))
        #expect(![1].contains(anyElementsIn: [0 ... 0]))
        #expect(![0].contains(anyElementsIn: [1 ... 1]))
    ...
    @Test
    func contains_anyElementsIn_ClosedRanges_multipleRanges() {
    ...
    @Test
    func count_ofElementsIn_ClosedRange() {
    ...
    @Test
    func count_ofElementsIn_ClosedRanges_noRanges() {
    ...
    @Test
    func count_ofElementsIn_ClosedRanges_oneRange() {
        #expect(([] as [Int]).count(ofElementsIn: [0 ... 1]) == 0)
        #expect([0].count(ofElementsIn: [0 ... 0]) == 1)
        #expect([1].count(ofElementsIn: [0 ... 0]) == 0)
        #expect([0].count(ofElementsIn: [1 ... 1]) == 0)
    ...
    @Test
    func count_ofElementsIn_ClosedRanges_multipleRanges() {
    ...
    func stringCollection_localizedRemovingDuplicates() {
    ...
    @Test(.enabled(ifLocaleIdentifierHasPrefix: "en"))
    func stringCollection_localizedCaseInsensitiveRemovingDuplicates() {
    ...
    @Test(.enabled(ifLocaleIdentifierHasPrefix: "en"))
    func stringCollection_localizedStandardRemovingDuplicates() {
