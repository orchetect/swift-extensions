...
@Suite
struct Extensions_Foundation_Decimal_Tests {
    @Test
    ...
    func integralDigitPlaces_and_fractionDigitPlaces() {
        ...
        #expect(Decimal(10000.123 as Double).integralDigitPlaces == 5)
        #expect(Decimal(10000.123 as Double).fractionDigitPlaces == 3)
        #expect(Decimal(-10000.123 as Double).integralDigitPlaces == 5)
        #expect(Decimal(-10000.123 as Double).fractionDigitPlaces == 3)

        #expect(Decimal(10000.0 as Double).integralDigitPlaces == 5)
        #expect(Decimal(10000.0 as Double).fractionDigitPlaces == 0)
        #expect(Decimal(-10000.0 as Double).integralDigitPlaces == 5)
        #expect(Decimal(-10000.0 as Double).fractionDigitPlaces == 0)

        #expect(Decimal(12345.0 as Double).integralDigitPlaces == 5)
        #expect(Decimal(12345.0 as Double).fractionDigitPlaces == 0)
        #expect(Decimal(-12345.0 as Double).integralDigitPlaces == 5)
        #expect(Decimal(-12345.0 as Double).fractionDigitPlaces == 0)

        #expect(Decimal(12345.67 as Double).integralDigitPlaces == 5)
        #expect(Decimal(12345.67 as Double).fractionDigitPlaces == 2)
        #expect(Decimal(-12345.67 as Double).integralDigitPlaces == 5)
        #expect(Decimal(-12345.67 as Double).fractionDigitPlaces == 2)
    }
}
